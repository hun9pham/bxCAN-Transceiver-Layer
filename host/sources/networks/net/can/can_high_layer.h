...
#define CAN_PHYTX_MAX_RETRY         (1)
#define GW_CANNODE_FILTER_ID        (0x03)
...
typedef enum eCanRecvParserState {
	CAN_PARSER_STATE_SOF = 0x00,
    CAN_PARSER_STATE_DES_CANNODE,
    CAN_PARSER_STATE_SRC_CANNODE,
    CAN_PARSER_STATE_TYPE,
	CAN_PARSER_STATE_LEN,
	CAN_PARSER_STATE_DATA,
	CAN_PARSER_STATE_FCS,
	CAN_PARSER_STATE_EOF,
...
/* Extern variables ----------------------------------------------------------*/
extern q_msg_t taskCanHighLayerMailbox;

/* Function prototypes -------------------------------------------------------*/
extern void* TaskCanHighLayerEntry(void*);
